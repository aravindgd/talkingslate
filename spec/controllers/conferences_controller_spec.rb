  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved conference as @conference" do
        ...
        post :create, {:conference => { "name" => "invalid value" }}, valid_session
        assigns(:conference).should be_a_new(Conference)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested conference" do
        ...
        Conference.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => conference.to_param, :conference => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the conference as @conference" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Conference.any_instance.stub(:save).and_return(false)
        put :update, {:id => conference.to_param, :conference => { "name" => "invalid value" }}, valid_session
        assigns(:conference).should eq(conference)
      end
